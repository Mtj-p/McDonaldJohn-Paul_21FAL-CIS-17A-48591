/*
 * file: McDonaldJohnPaul_CodeE_Q1_Mode
 * Author: John-Paul McDonald
 * Date: 09/29/2021
 * Purpose: Find the Mode (Code-E code paste)
 */
...
int *mode(const int *array,int arySize){
    ...
    modeAry[0]=maxFreq;//Stub returns no modes
    modeAry[1]=modes;//Stub returns Frequency 1
